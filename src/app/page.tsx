...
export default function Home() {
  return (
    <div className="bg-dotted flex flex-col sm:flex-row w-full h-screen justify-center items-center gap-4">
  <div className="sm:w-1/2 lg:w-3/5 transition-all mt-1 flex flex-col items-center">
